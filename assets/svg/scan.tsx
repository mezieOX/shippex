...
interface ScanIconProps {
  size: number; // Specify size as a number
  color: string; // Specify color as a string
}

export const ScanIcon: React.FC<ScanIconProps> = ({ size, color }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 32 25" fill="none">
